    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Allowance & Deductions',
                    'url' => 'admin/allowances-deductions',
                    'icon' => 'fas fa-fw fa fa-circle',
                ],
                [
                    'text' => 'Asset Types',
                    'url' => 'admin/asset-types',
                    'icon' => 'fas fa-fw fa fa-font',
                ],
                [
                    'text' => 'Loan Types',
                    'url' => 'admin/loan-types',
                    'icon' => 'fas fa-fw fa fa-list',
                ],
            ]
        ],
